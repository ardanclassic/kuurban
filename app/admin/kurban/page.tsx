...
export default function AdminKurbanPage() {
  ...
  return (
    <>
      <FullScreenLoader isLoading={isLoading} text="Memuat Data Shohibul..." />
      <div className={cn("space-y-6 pb-20 transition-opacity duration-500", isLoading ? "opacity-0" : "opacity-100")}>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-3">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/10 rounded-full border border-emerald-500/20">
                  ...
                  <span className="text-[10px] font-bold text-emerald-300 uppercase tracking-[0.2em]">Manajemen Shohibul Qurban</span>
                </div>
                ...
                <p className="text-slate-400 text-xs md:text-sm font-medium pr-10">
                  Manajemen data warga yang berpartisipasi dalam qurban.
                </p>
              </div>
