...
export default function AdminDashboard() {
  ...
  const stats = [
    ...
    { label: "Total Kambing Terdata", value: kurbanData === undefined ? "-" : countKambing.toString(), trend: "Ekor", icon: ShoppingBag, color: "text-amber-600", bg: "bg-amber-50" },
        ...
        <div className="relative z-10 flex flex-col gap-6 md:gap-8">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-500/10 rounded-full border border-indigo-500/20">
              ...
              <span className="text-[10px] font-bold text-indigo-300 uppercase tracking-[0.2em]">Idul Adha 1447 H</span>
            </div>
            ...
            <p className="text-slate-400 text-xs md:text-sm font-medium pr-10">
              Ringkasan performa data shohibul, koordinasi panitia, dan hasil putusan rapat terbaru.
            </p>
          </div>
