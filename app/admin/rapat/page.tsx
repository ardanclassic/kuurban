...
export default function HasilRapatPage() {
  ...
  const isLoading = rawRapatData === undefined;
  ...
  return (
    <>
      <FullScreenLoader isLoading={isLoading} text="Memuat Notulensi..." />
      <div className={cn("space-y-6 max-w-4xl pb-10 transition-opacity duration-500", isLoading ? "opacity-0" : "opacity-100")}>
        {/* DYNAMIC HERO HEADER */}
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-3">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-500/10 rounded-full border border-indigo-500/20">
                  ...
                  <span className="text-[10px] font-bold text-indigo-300 uppercase tracking-[0.2em]">Notulensi</span>
                </div>
                ...
                <p className="text-slate-400 text-xs md:text-sm font-medium pr-10">
                  Klik pada kartu di bawah untuk melihat detail notulensi.
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 gap-3">
          {rapatData === undefined ? (
            ...
            <div className="py-10 text-center">
              <p className="text-slate-400 font-bold text-sm">Belum ada notulensi.</p>
            </div>
          )}
        </div>
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6">
                  <div className="space-y-4">
                    <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Deskripsi:</h4>
                  ...
                  {/* Point Points */}
                  <div className="space-y-3">
                    <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Hasil Musyawarah:</h4>
